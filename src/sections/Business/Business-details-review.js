...
//
import ProductReviewList from './Business-review-list';
import ProductReviewNewForm from './Business-review-new-form';

// ----------------------------------------------------------------------

export default function BusinessDetailsReview({ totalRatings, totalReviews, ratings, reviews }) {
...
BusinessDetailsReview.propTypes = {
